...
import "../../../royalties/contracts/royaltiesImpl/RoyaltiesVersion2Impl.sol";
import "../../../royaltiesUpgrade/contracts/RoyaltiesVersion2Upgrade.sol";
import "../../../lazymintsupport/contracts/erc-1155/IERC1155LazyMintingSupport.sol";
import "./Mint1155Validator.sol";
import "./ERC1155BaseURI.sol";

abstract contract ERC1155Lazy is IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesVersion2Upgrade, RoyaltiesVersion2Impl {
    ...
    function transferFromOrMintTo(
        ...
        if (left > 0) {
            mintAndTransferTo(data, to, left);
        }
    }

    function mintAndTransferTo(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override virtual {
